        ...
        <div id="landingPage" className=' py-7 relative overflow-x-hidden w-full h-screen bg-[#fff1e4] ' >
          ...
          <div className=' absolute w-full h-full top-0 left-0 flex justify-start items-center'>
            <div className=' p-4 md:w-7/12 sm:w-10/12 w-full '>
              <h2 className=' nunito text-5xl font-bold p-4'>CLASS VIBE</h2>
              <p className='nunito text-xl p-4'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae numquam pariatur, voluptates sequi nostrum </p>
